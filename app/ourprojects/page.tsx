...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <div className="">
      <Image src={virndavan} alt="virndavan" className=" z-0 w-full h-[38vw]" />
 ...
 {/* projects */}
     ...
     {/* ABOUT SECTION */}
           <section className="py-20 px-20" data-aos="fade-up">
             <div className=" lg:flex flex-cols mx-10">
               <Image
                 src={aboutTemImage}
               ...
               <div className="px-0 lg:px-10 py-10">
                 <h1 className="text-[#313036] font-['CanelaDeck-Light'] text-6xl">Project Name</h1>
