  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="my-5 mx-5 lg:mx-20">
        {/* projects */}
        <h1 className="text-[#313036]   font-bold text-4xl text-center mt-10">Hanumat Vihar Awas Yojna (MVDA) <br /></h1>
        ...
        <section className="py-20 px-0 lg:px-2" data-aos="fade-up">
          <div className="lg:flex lg:justify-between flex-cols mx-10 lg:mx-1">
            ...
            <h1 className="text-[#313036]   font-bold text-4xl"><span className="text-2xl font-medium font-normal">Radha Kund – Raall Road, Vrindavan</span> <br /><span className="text-2xl font-medium font-normal">RERA Approved Residential Township</span></h1>
