  ...
  >
    <source src="https://cdn.brandsdoor.in/indiadealss/indiadealss/1771136869498-indiadeals-group-home-banners.mp4" type="video/mp4" />
      ...
      <section className="pt-20 pb-10 px-2 lg:px-20" data-aos="fade-up">
        <div className=" lg:flex  mx-5">
          ...
          <div className="px-0 lg:px-10 py-10">
            <h1 className="text-[#313036] font-['CanelaDeck-Light'] font-bold text-4xl">Hanumat Vihar Awas Yojna (MVDA) <br /><span className="text-2xl font-medium font-normal">Radha Kund – Ral Road, Vrindavan</span> <br /><span className="text-2xl font-medium font-normal">RERA Approved Residential Township</span></h1>
      ...
      <div className="pt-5 px-2 lg:px-20">
          ...
          <p className="text-gray-600 font-['poppins'] my-10">
              <ul className="list-disc ps-10 space-y-5 leading-7 pl-5">
