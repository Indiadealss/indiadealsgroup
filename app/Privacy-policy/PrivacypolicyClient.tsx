      ...
      <div className='px-5 lg:px-[22%] my-10 '>
                ...
                <div className='mt-5'>
                    ...
                    <div className='mt-5'>
                       ...
                       <span className='ms-1 text-justify'>We only use your data in ways that support our services and communication with you.</span>
                    </div>
